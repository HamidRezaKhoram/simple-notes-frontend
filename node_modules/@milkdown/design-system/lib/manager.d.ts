import type { Ctx, MilkdownPlugin, Slice } from '@milkdown/ctx';
...
export declare class ThemeManager {
    ...
    getSlice<Key extends ThemeSliceKey<any, any, any>, Ret extends GetRet<Key> = GetRet<Key>, Payload extends GetPayload<Key> = GetPayload<Key>, K extends GetKey<Key> = GetKey<Key>>(key: Key | (K & string)): ThemeSlice<Ret, Payload>;
