...
export type GetPlugin<SupportedKeys extends string = string, Options extends {} = {}> = (options?: Partial<CommonOptions<SupportedKeys, Options>>) => MilkdownPlugin;
export interface Metadata<Origin = unknown> {
    origin: Origin;
}
export type AddMetadata<SupportedKeys extends string = string, Options extends {} = {}> = (options?: Partial<CommonOptions<SupportedKeys, Options>>) => Metadata<GetPlugin<SupportedKeys, Options>> & MilkdownPlugin;
export type Spec<SupportedKeys extends string, Type, Rest> = Methods<SupportedKeys, Type> & Rest;
export type Factory<SupportedKeys extends string, Options extends {}, Type, Rest> = (utils: ThemeUtils, options?: Partial<CommonOptions<SupportedKeys, Options>>) => Spec<SupportedKeys, Type, Rest>;
export interface Extendable<SupportedKeys extends string, Options extends {}, Type, Rest> {
    extend: <ExtendedSupportedKeys extends string = SupportedKeys, ExtendedOptions extends {} = Options, ExtendedType extends Type = Type, ExtendedRest extends Rest = Rest>(extendFactory: (...args: [
    ...
    ]) => Spec<ExtendedSupportedKeys, ExtendedType, ExtendedRest>) => WithExtend<ExtendedSupportedKeys, ExtendedOptions, Type, Rest>;
}
export type WithExtend<SupportedKeys extends string, Options extends {}, Type, Rest> = AddMetadata<SupportedKeys, Options> & Extendable<SupportedKeys, Options, Type, Rest>;
