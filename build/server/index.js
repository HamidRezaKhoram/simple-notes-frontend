import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/index-f40d9d0b.js';
import { e as error, j as json, R as Redirect, H as HttpError, A as ActionFailure } from './chunks/index2-6a9b411a.js';
import { i as is_primitive, g as get_type, s as stringify_string, D as DevalueError, a as is_plain_object, e as escaped } from './chunks/utils-9b0de2f4.js';
import { w as writable, r as readable } from './chunks/index3-6393c015.js';
...
function get_cookies(request, url, dev, trailing_slash) {
  ...
  if (dev) {
    const initial_decoded_cookies = cookieExports.parse(header, { decode: decodeURIComponent });
...
class Server {
  ...
  async init({ env }) {
    ...
    if (!this.options.hooks) {
      const module = await import('./chunks/hooks.server-f5781e78.js');
      this.options.hooks = {
